...
public class FileOutputStreamMain {
	...
	public static void main(String[] args) throws Exception {
		...
		FileOutputStream fos=new FileOutputStream("fileOut.dat");			//fos -> 빨대를 생성했다.
		/*
		 ...
		 */
		/*
		 * 65 -->00000000000000000000000001000001 66 -->00000000000000000000000001000010
		 * 67 -->00000000000000000000000001000011 21483647

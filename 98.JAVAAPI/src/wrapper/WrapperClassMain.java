...
public class WrapperClassMain {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < scoreArray.length; i++) {
			/*
			Integer tempScore = (Integer)scoreArray[i];			// int.. 강제형변환 해주기(상위 -> 하위니까)
			int score = tempScore.intValue();
			System.out.println(score + " ");
			 */
			int score = (Integer)scoreArray[i];		// wrapper 객체 사용할 때...... 비교하려면..          Integer로 캐스팅 된 후 언박싱하는 것
			System.out.print(score+" ");
		}
		
		// wrapper 객체간 비교를 지양하고 값을 꺼내서(언박싱)해서 사용할 것 <<<주의>>>
		/*******************************************************/
		System.out.println();

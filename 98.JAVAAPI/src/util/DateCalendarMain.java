...
public class DateCalendarMain {
	...
	public static void main(String[] args)throws Exception {
		...
		/*
		 * SimpleDateFormat : Date 객체의 시간을 문자열로 변경해주는 클래스
		 */
		...
		Date myBirthDay = sdf2.parse("1995-06-30");
		System.out.println(myBirthDay.toString());
		System.out.println(myBirthDay.toLocaleString()); // The method toLocaleString() from the type Date is deprecated <- 오래되었으니 다른거 써라.. long타입 외에는 쓰지마라...
		...
		*/
		...
		java.util.Date utilDate1 = new java.util.Date(); // ? long date는 유닉스타입???
		// java.util.Date utilDate1 = new java.util.Date(System.currentTimeMillis()); 윗 줄과 같은..
		...
		java.sql.Date sqlDate3 = new java.sql.Date(System.currentTimeMillis()); // sql.Date는 기본생성자X 반드시 long date를 넣어줘야한다.
		java.sql.Date sqlDate4 = java.sql.Date.valueOf("2022-12-31");
		
		java.util.Date utilDate3 = sqlDate3;
		java.util.Date utilDate4 = sqlDate3;
		System.out.println("utilDate3 : " + utilDate3);
		System.out.println("utilDate4 : " + utilDate4);
		// 변경이라기 보다는 상위타입으로.. 형변환되는.. (util이 sql보다 상위니까)
		/***************************************************************************************/		

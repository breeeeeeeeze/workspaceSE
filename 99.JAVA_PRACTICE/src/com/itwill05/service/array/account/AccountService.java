...
public class AccountService {
	...
	*/
	...
	public void totAccountNumberPrint() {
		System.out.println("총 계좌 수 : " + accounts.length + "개");
	}
	/*
	 * 2.은행계좌들 전체출력메쏘드 정의
	 */
	...
	public void totBalancePrint() {	
		...
		System.out.println("모든 계좌의 총 잔고 : " + totBalance);
	}
	...
	*/
	public void updateAccount(Account updateAccount) {
		System.out.println("-------- 수정된 계좌 정보 ---------");
		for (int i = 0; i < accounts.length; i++) {
			accounts[i].setAccountData(updateAccount.getNo(), updateAccount.getOwner(), updateAccount.getBalance(), updateAccount.getIyul());
			accounts[i].print();
			break;
		}
	}

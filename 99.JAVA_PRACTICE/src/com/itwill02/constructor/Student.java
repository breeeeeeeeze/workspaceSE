package com.itwill02.constructor;
	...
	public class Student {
		...
		public void headerPrint() {
			...
			System.out.printf("%2s %4s %4s %3s %3s %3s %3s %s %s%n", "학번", "이름", "국어", "영어", "수학", "총점", "평균", "평점", "석차");
			System.out.printf("-------------------------------------------------------%n");
		 ...
		 */
		public void print() {
			System.out.printf("%3d %5s %4d %5d %5d %5d %6.1f %3c %4d%n", this.no, this.name, this.kor, this.eng, this.math,

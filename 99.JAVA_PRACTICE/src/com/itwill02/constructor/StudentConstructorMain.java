package com.itwill02.constructor;
	public class StudentConstructorMain {
		public static void main(String[] args) {
			...
			student1.setStudentData(1, "김이름", 90, 72, 36);
			Student student2 = new Student(2, "이이름", 62, 78, 89);
			Student student3 = new Student(3, "박이름", 99, 88, 95);
			 ...
			 */
			student1.setName("김땡땡");
			student1.headerPrint();
			student1.print();
			student1.getTot();
			System.out.println(student1.getName() + "의 총점 : " + student1.getTot());
			student1.getGrade();	
			System.out.println(student1.getName() + "의 학점 : " + student1.getGrade());
		}
	}
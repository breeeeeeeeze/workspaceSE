...
public class MemberMainFrame extends JFrame {
	...
	*/
	...
	public MemberMainFrame()throws Exception {
		...
		memberMainLB.setIcon(new ImageIcon(MemberMainFrame.class.getResource("/images/penguin_back.jpg")));
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"김경호", "김경미", "김경양", "김경가", "김경나"}));
		comboBox.setBounds(201, 221, 146, 23);
